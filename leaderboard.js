...
$(document).ready(function(){
    ...
    const APIKEY = "RGAPI-6503490f-5db6-48a7-868e-97b87cb97f3b"; //täytyy päivittää 24h välein kunnes saa Node.js serverin hoitamaan API kyselyt ja APIKEY on piilossa .env tiedostossa
